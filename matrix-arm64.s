...
.section .rodata
// Each entry is exactly CHAR_SLOT bytes (UTF-8 + null padding), occupies
// 2 terminal cells. Full-width chars: 3-byte UTF-8 + \0. Narrow chars:
// bytes + space + null padding.
chars:
    // カタカナ
    ...
    // 漢字
    .ascii "天\0" "地\0" "人\0" "心\0" "神\0" "龍\0"
    .ascii "虎\0" "光\0" "水\0" "火\0" "月\0" "星\0"
    // ハングル
    .ascii "가\0" "나\0" "다\0" "라\0" "마\0" "바\0" "사\0" "아\0"
    // ギリシャ
    .ascii "α \0" "β \0" "γ \0" "δ \0" "ε \0" "ζ \0"
    .ascii "η \0" "θ \0" "λ \0" "μ \0" "π \0" "ω \0"
    // ヘブライ
    .ascii "א \0" "ב \0" "ג \0" "ד \0" "ה \0" "ו \0"
    .ascii "ז \0" "ח \0" "ט \0" "י \0" "כ \0" "ל \0"
    // キリル
    .ascii "Д \0" "Ж \0" "З \0" "И \0" "Л \0" "П \0" "Ф \0" "Я \0"
    // タイ
    .ascii "ก " "ข " "ค " "ง " "จ " "ด " "ต " "บ "
    // デーヴァナーガリー
    .ascii "क " "ख " "ग " "घ " "च " "ट " "त " "द "
    // ルーン
    .ascii "ᚠ\0" "ᚢ\0" "ᚦ\0" "ᚨ\0" "ᚱ\0" "ᚲ\0" "ᛏ\0" "ᛒ\0"
    // 数字
